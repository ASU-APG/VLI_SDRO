...
class VQADataset:
    ...
    def __init__(self, splits: str):
        ...
        for split in self.splits:
            # self.data.extend(json.load(open(VQA_DATA_ROOT + "%s_yesno.json" % split)))
            self.data.extend(json.load(open(VQA_DATA_ROOT + "%s_yesno_si.json" % split)))
            # Loading sp file
            self.data.extend(json.load(open(VQA_DATA_ROOT + "%s_yesno_sp.json" % split)))
