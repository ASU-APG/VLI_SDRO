...
for T in [20]:
    ...
    prediction_file_path = "/data_1/data/uniter/finetune/villa_base_finetuned_recent_si_sp_results/results.csv"
    acc_file_path = "test_accuracies/textattack/test_orig_test_cat_accuracy.json"
